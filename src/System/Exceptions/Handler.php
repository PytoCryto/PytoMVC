...
namespace PytoMVC\System\Exceptions;
...
/**
 * @source: https://github.com/laravel/framework/blob/5.3/src/Illuminate/Foundation/Exceptions
 */
class Handler implements ExceptionHandlerContract
{
    ...
    protected function shouldntReport(Exception $e)
    {
        $dontReport = array_merge($this->dontReport, [
            ...
            HttpRouteNotFoundException::class,
    ...
    {
        if ($e instanceof HttpRouteNotFoundException || $e instanceof ModelNotFoundException) {
            ...
            $e = new HttpException(Response::HTTP_METHOD_NOT_ALLOWED, $e->getMessage());
        }
    ...
    public function render($request, Exception $e)
    {
        ...
        } elseif ($e instanceof \PytoTPL\Exception\NotFoundException) {
            //
        }
    ...
    protected function renderHttpException(HttpException $e)
    {
        ...
        try {
            return view('errors.' . $status, ['exception' => $e], $status);
        } catch(\PytoTPL\Exception\NotFoundException $tplException) {
