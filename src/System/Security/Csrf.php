...
namespace PytoMVC\System\Security;
/**
...
class CSRF
{
    ...
    public function validate($token, $name = null)
    {
        if ($this->validateToken($token, $name)) {
            $this->regenerateToken($name);
    ...
    public function getToken($name = null)
    {
        ...
        $token = $token ?: $this->regenerateToken($name);
